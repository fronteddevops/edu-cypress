...
Then('the toaster notification should be displayed if data length is greater than', () => {
  // Verify the toaster notification for "already exists"
//   cy.get('.toast-container') 
//     .should('be.visible')
//     .and('contain.text', 'Paper number already exists');
});
